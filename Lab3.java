...
public class Lab3 {
    public static enum LexemeType {
        ...
        String("\"[^\"]*\"|'[^']*'|`[^`]*`"),
        Comment("#.*"),
        Keyword("\\b(break|False|catch|class|def|continue|del|do|else|elif|import|lambda|finally|for|if|in|is|not|new|return|False|None|from|throw|try|or|pass|raise|while|with|yield|and|as|True|global|nonlocal|await|async|assert|print|append|round|format|range|__name__|__init__)\\b"),
